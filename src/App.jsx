...
const PROXY = '/api/yahoo/v8/finance/chart/NVDA'
...
/* Nvidia eye/swoosh logo as SVG */
function NvidiaLogo({ size = 52 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="nv" x1="0" y1="0" x2="52" y2="52" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#76B900" />
          <stop offset="100%" stopColor="#5a8f00" />
        </linearGradient>
      </defs>
      <rect width="52" height="52" rx="12" fill="url(#nv)" />
      <path d="M20.5 18c3.2-1.8 7-1.2 9.5 1.2l-3.5 3.5c-1.5-1.3-3.8-1.5-5.5-.4-2.5 1.6-2.5 5.8 0 7.4 1.7 1.1 4 .9 5.5-.4l3.5 3.5c-2.5 2.4-6.3 3-9.5 1.2-4.8-2.7-4.8-9.7 0-12.5z" fill="white" opacity=".95" />
      <path d="M30 22.5c2 2.5 2 6.5 0 9l3.5-4.5L30 22.5z" fill="white" opacity=".7" />
    </svg>
  )
}
...
export default function App() {
  ...
  return (
    <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 8 }}>
          ...
          <div>
            <h1 style={{
              ...
              Nvidia <span style={{ color: 'var(--text-3)', fontWeight: 500, fontSize: 24 }}>NVDA</span>
            </h1>
      ...
      >
        {[
          { label: 'Market Cap', value: formatBigNum(meta.marketCap || (price * 24.49e9)) },
